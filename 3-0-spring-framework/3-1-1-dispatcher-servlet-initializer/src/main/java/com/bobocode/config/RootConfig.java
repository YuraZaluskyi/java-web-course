...
/**
 * This class provides application root (non-web) configuration for a basic spring application
 * context (containing middle-tire services, datasource, etc.). The configuration must exclude the
